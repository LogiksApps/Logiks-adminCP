	...
	lgksPopup("#changeMode",
			...
			{width:300,height:100,show:"blind",hide:"blind",closeOnEscape:true,
				close: function(event, ui) {
					...
					if(v=="php") loadAC("#workspace input.autocomplete",getServiceCMD("lookups")+"&src=cmds-php");
					else if(v=="bash") loadAC("#workspace input.autocomplete",getServiceCMD("lookups")+"&src=cmds-bash");
				}
			}
		);
}
